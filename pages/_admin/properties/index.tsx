...
const AdminProperties: NextPage = ({ initialInquiry, ...props }: any) => {
	...
	/** APOLLO REQUESTS **/
	const [updatePropertytByAdmin] = useMutation(UPDATE_PROPERTY_BY_ADMIN);
	const [removePropertytByAdmin] = useMutation(REMOVE_PROPERTY_BY_ADMIN);

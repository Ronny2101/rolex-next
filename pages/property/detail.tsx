								...
								<Stack className={'left-box'}>
									...
									<Stack className={'top-box'}>
										...
										<Stack className={'buy-rent-box'}>
											...
											{property?.propertyLimitedEdition && (
												<>
													<Stack className={'circle'}>
														<svg xmlns="http://www.w3.org/2000/svg" width="6" height="6" viewBox="0 0 6 6" fill="none">
															<circle cx="3" cy="3" r="3" fill="#EB6753" />
													...
													<Typography className={'buy-rent'}>Edition</Typography>
												</>
											)}
										</Stack>
										<Stack className={'divider'}></Stack>
									...
									<Stack className={'bottom-box'}>
										<Stack className="option">
											<img src="/img/icons/auto.png" alt="" className='option-png' /> <Typography>{property?.propertyMovement}</Typography>
										</Stack>
										<Stack className="option">
											<img src="/img/icons/material.png" alt="" className='option-png'/> <Typography>{property?.propertyMaterial}</Typography>
										</Stack>
										<Stack className="option">
											<img src="/img/icons/size.png" alt="" className='option-png'/> <Typography>{property?.propertySize} mm</Typography>
										</Stack>
									</Stack>
								</Stack>
								...
								<Stack className={'options-config'}>
									<Stack className={'option'}>
										...
										<Stack className={'option-includes'}>
											...
											<Typography className={'option-data'}>{property?.propertyMovement}</Typography>
										</Stack>
									</Stack>
									<Stack className={'option'}>
										<Stack className={'svg-box'}>
											<img src={'/img/icons/material.png'} />
										</Stack>
										<Stack className={'option-includes'}>
									...
									<Stack className={'bottom'}>
										...
										<Stack className={'info-box'}>
											<Stack className={'left'}>
												...
												<Box component={'div'} className={'info'}>
													<Typography className={'title'}>Movement</Typography>
													<Typography className={'data'}>{property?.propertyMovement}</Typography>
												</Box>
											</Stack>
											<Stack className={'right'}>
												...
												<Box component={'div'} className={'info'}>
													...
													<Typography className={'data'}>
														For {property?.propertyBarter && 'Barter'} {property?.propertyLimitedEdition && 'LimitedEdition'}
													</Typography>
												</Box>
											</Stack>
										</Stack>

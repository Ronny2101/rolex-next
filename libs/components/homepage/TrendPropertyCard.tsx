		...
		return (
			<Stack className="trend-card-box" key={property._id}>
				...
				>
					<img  src={imagePath} alt={property.propertyTitle} loading="lazy" />
						...
						{property?.propertyType && (
							<Box className="badge">
								<Typography className="badge-text">{t(property.propertyType)}</Typography>
							</Box>
						)}
				...
				<Stack component={'div'} className={'info'}>
					...
					<div className={'bott'}>
						<p>
							{property.propertyLimitedEdition ? 'LimitedEdition' : ''} {property.propertyLimitedEdition && property.propertyBarter && '/'}{' '}

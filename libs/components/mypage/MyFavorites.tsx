...
const MyFavorites: NextPage = () => {
	...
	if (device === 'mobile') {
		return <div>ROLEX MY FAVORITES MOBILE</div>;
	} else {
		return (
				...
				<Stack className="favorites-list-box">
					{myFavorites?.length ? (
						myFavorites?.map((property: Property) => {
							return <PropertyCard key={property._id} property={property} likePropertyHandler={likePropertyHandler} myFavorites={true} />;
						})
					) : (
